        ...
        <form action="{{route('brand.store')}}" method="POST">
            @csrf
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('name') is-invalid @enderror" type="text" value="{{old('name')}}" name="name" placeholder="Brand Name" >
                            @error('name')
                ...
                <div class="m-t-20 text-center">
                    <button class="btn btn-primary submit-btn">Create Brand</button>
                </div>
            </form>
        </div>
    </div>
