...
<div class="content">
    <div class="row">
        <div class="col-sm-4 col-3">
            <h4 class="page-title">Quentity Type</h4>
        </div>
        <div class="col-sm-8 col-9 text-right m-b-20">
            <a href="{{route('item.create')}}" class="btn btn-primary float-right btn-rounded"><i class="fa fa-plus"></i> Add Quentity Type</a>
        </div>
    </div>
    {{--
                ...
                <table class="table table-striped custom-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @endif
                            <td class="text-right">
                            <a class="" href="{{route('item.edit',$cat->id)}}"><i class="fa fa-pencil m-r-5"></i> Edit</a>
