...
<div class="content">
    <div class="row">
        ...
        <div class="col-sm-8 col-9 text-right m-b-20">
            <a href="{{route('room_type.create')}}" class="btn btn-primary float-right btn-rounded"><i class="fa fa-plus"></i> Add Room Type</a>
        </div>
    </div>
    {{--
                ...
                <table class="table table-striped custom-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @endif
                            <td class="text-right">
                            <a class="" href="{{route('room_type.edit',$cat->id)}}"><i class="fa fa-pencil m-r-5"></i> Edit</a>

                                <form action="{{route('room_type.destroy',$cat->id)}}" method="POST">
                                    @csrf
                                    @method('DELETE')
